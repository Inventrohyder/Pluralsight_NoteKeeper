...
public class NoteReminderReceiver extends BroadcastReceiver {
    public static final String EXTRA_NOTE_TITLE = "com.inventrohyder.noteKeeper.NOTE_TITLE";
    public static final String EXTRA_NOTE_TEXT = "com.inventrohyder.noteKeeper.NOTE_TEXT";
    public static final String EXTRA_NOTE_ID = "com.inventrohyder.noteKeeper.NOTE_ID";
