...
public class NoteKeeperProvider extends ContentProvider {
    ...
    public String getType(@NonNull Uri uri) {
        ...
        switch (uriMatch) {
            case COURSES:
                // vnd.android.cursor.dir/vnd.com.inventrohyder.pluralsight_notekeeper.courses
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Courses.PATH;
                break;
            case NOTES:
                // vnd.android.cursor.dir/vnd.com.inventrohyder.pluralsight_notekeeper.notes
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
                        MIME_VENDOR_TYPE + Notes.PATH;
                break;
            case NOTES_EXPANDED:
                // vnd.android.cursor.dir/vnd.com.inventrohyder.pluralsight_notekeeper.notes_expanded
                mimeType = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" +
